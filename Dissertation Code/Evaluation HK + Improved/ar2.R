...
foreach(t = 1:REP) %dopar% {
  ...
  file_name <- paste("try", t, "_rights_ar2_",phi1,"_",phi2,".txt", sep = "")
  lapply(rights, write, file_name, append = TRUE, ncolumns = length(NN))
  
  file_name <- paste("try", t, "_wrongs00_ar2_",phi1,"_",phi2,".txt", sep = "")
  lapply(wrongs_00, write, file_name, append = TRUE, ncolumns = length(NN))
  
  file_name <- paste("try", t, "_wrongs01_ar2_",phi1,"_",phi2,".txt", sep = "")
  lapply(wrongs_01, write, file_name, append = TRUE, ncolumns = length(NN))
  
  file_name <- paste("try", t, "_wrongs22_ar2_",phi1,"_",phi2,".txt", sep = "")
